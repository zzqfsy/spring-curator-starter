...
public class CuratorAutoConfiguration implements BeanFactoryAware {
    private Logger log = LoggerFactory.getLogger(CuratorAutoConfiguration.class);
    ...
    public CuratorFramework curatorFramework(RetryPolicy retryPolicy) {
        ...
        } else if(StringUtils.hasText(curatorProperties.getScheme()) && StringUtils.hasText(curatorProperties.getAuthStr())) {
            builder.authorization(curatorProperties.getScheme(), curatorProperties.getAuthStr().getBytes());
        }
